...
>(({ data, totals }, ref) => {
  ...
  return (
    <div ref={ref} className="bg-white text-black text-sm p-12 font-serif relative" style={{width: '210mm', minHeight: '297mm'}}>
      ...
      <footer className="absolute bottom-12 left-12 right-12 text-xs text-neutral-600 space-y-4">
