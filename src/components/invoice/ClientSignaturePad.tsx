...
export const ClientSignaturePad: React.FC<ClientSignaturePadProps> = ({ signature, onSignatureChange }) => {
        ...
        <Tabs defaultValue={isImage ? "upload" : "text"} className="w-full">
          ...
          <TabsContent value="text" className="pt-4">
             <div className="space-y-2">
                <Label htmlFor="client-signature-text">Type Name</Label>
                <Input
                    id="client-signature-text"
          ...
          <TabsContent value="upload" className="pt-4">
            <div className="space-y-2">
                <Label htmlFor="client-signature-upload">Signature Image</Label>
                <div
